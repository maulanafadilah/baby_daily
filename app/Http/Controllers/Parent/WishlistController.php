...
class WishlistController extends Controller
{
    ...
    public function index()
    {
        ...
        $wishlist = Wishlist::select('products.nama_produk', 'products.id', 'products.harga', 'wishlists.id as idw', 'products.cover')->where('id_pengguna', auth()->user()->id)->join('products', 'wishlists.id_produk', '=', 'products.id')->get();
